...
const Upload = () => {
  ...
  return (
    <div className='bg-black p-5 px-5 lg:px-28'>

      {!uploadComplete ?
        <div>
          <h2 className='text-2xl text-center m-5 text-white'>Start
            <strong className='text-violet-500'> Uploading </strong>
            File and <strong className='text-violet-500'> Share </strong> it
          </h2>
