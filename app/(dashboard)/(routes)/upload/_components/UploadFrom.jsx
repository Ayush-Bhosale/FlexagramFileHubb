    ...
    return (
        <div className='text-center'>
            <div className="flex items-center justify-center w-full mt-10">
                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-blue-300 border-dashed rounded-lg cursor-pointer bg-blue-50   hover:bg-blue-100 dark:border-blue-600 dark:hover:border-blue-500 ">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <svg className="w-10 h-10 mb-4 text-violet-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                        </svg>
                        <p className="mb-2 text-xl lg:text-3xl text-black text-center">
                            <span className="font-semibold">
                                Click to upload </span>
                            or <strong className='text-violet-500'> drag </strong>
                            and <strong className='text-violet-500'> drop </strong>
                        </p>
                        <p className="text-xs text-black dark:text-gray-400">SVG, PNG, JPG or GIF (Max Size 2MB)</p>
                    </div>
            ...
            {progress ?
                ...
                :
                <button disabled={!file} className='relative h-[40px] p-2 bg-violet-500 text-white w-60 rounded-full mt-5  cursor-pointer disabled:cursor-not-allowed disabled:bg-gray-500'
                    onClick={() => {
                        uploadBtnClick(file)
                        setShow(true);
                    }}>
